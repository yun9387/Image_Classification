...
# エポック数
MAX_EPOCH = 3
train_img_dir = r"C:\Users\USER\anaconda3\envs\PCA_svm\Image_Crassification\img\train"
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Linear(16 * 125 * 125, 120)
        self.layer2 = nn.Linear(120, 84)
        self.layer3 = nn.Linear(84, 13)
    ...
    def forward(self, input_data):
        ...
        #print(input_data.shape)
        input_data = input_data.view(-1, 16 * 125 * 125)
        #print(input_data.shape)
